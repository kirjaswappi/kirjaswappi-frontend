...
export default function ScrollSearch() {
  ...
  return (
    <div className="relative w-full max-w-xl">
      <div
        className={`transition-all duration-300 ease-in-out ${isSearchVisible ? 'scale-105' : 'scale-100'}`}
      >
        <div
          className={`
        ...
        `}
        >
          <div className="flex items-center bg-white rounded-full p-1 border border-[#E5E5E5] shadow-lg">
        ...
        `}
        >
          <div className="flex items-center bg-white rounded-full p-1 gap-1 border border-[#E5E5E5] shadow-sm hover:shadow-md transition-shadow duration-200">
