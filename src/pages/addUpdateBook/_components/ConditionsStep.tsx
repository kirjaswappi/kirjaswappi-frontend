...
export default function ConditionsStep({ errors }: { errors: any }) {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 w-full">
      ...
      {/* Right column: Main content/message box */}
      <div className="flex-1 min-w-[220px] w-full flex flex-col lg:items-center lg:justify-center">
