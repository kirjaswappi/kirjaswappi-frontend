...
export default function BookDetails() {
  ...
  return (
    <div>
      ...
      <div className="container pb-32">
        ...
        <div>
          ...
          <p className="text-xs font-light font-poppins text-grayDark">
            A brief synopsis or description of the book’s content, providing
            potential swappers with an idea of what the book is about.
          </p>
        </div>
      ...
      <div
        className="h-16 flex items-center gap-5 justify-between text-xs font-normal px-6 fixed bottom-0  bg-white w-full"
        style={{
          boxShadow: "0px 0px 1px 0px #33333345",
        }}
      >
        <div>
          <p className="text-xs font-poppins">Offered by</p>
          <h3 className="text-sm font-poppins underline">Raisa Hossain</h3>
        </div>
        <div>
          <Button className="bg-primary text-white w-full px-6 py-3 font-poppins font-medium rounded-md">
            Request Swap
          </Button>
        </div>
      </div>
