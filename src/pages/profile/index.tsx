...
export default function Profile() {
    return (
        <div>
            ...
            <div className="absolute top-4/12 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[120px] h-[120px] rounded-full overflow-hidden bg-white">
                <Image src={userprofile} className="w-full h-full object-fill" />
            </div>
            <div className="container mt-20">
                ...
                <div className="bg-white py-2 px-5 grid grid-cols-3 my-5">
